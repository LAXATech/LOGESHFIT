    ...
    return (
        <section className="py-20 bg-accent">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-primary/80 text-xl mb-10 max-w-2xl mx-auto font-medium">
                    Stop guessing and start getting results. Book your free strategy call today and let's build your roadmap.
                </p>
